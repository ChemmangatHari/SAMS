...
<div>
  <br><br><br>
  <h4 align="center">Select Event Type*</h3>
  ...
  <label class="rad-label">
    <input type="radio" class="rad-input" name="rad">
    <div class="rad-design"></div>
    <div class="rad-text">Zonal</div>
  </label>

  <label class="rad-label">
    <input type="radio" class="rad-input" name="rad">
    <div class="rad-design"></div>
    <div class="rad-text">State</div>
  </label>

  <label class="rad-label">
    <input type="radio" class="rad-input" name="rad">
    <div class="rad-design"></div>
    <div class="rad-text">National</div>
  </label>

  <label class="rad-label">
    <input type="radio" class="rad-input" name="rad">
    <div class="rad-design"></div>
    <div class="rad-text">International</div>
  </label>

  <br><br>
  <h4 align="center">Name of the event*</h3>
  <form align="center">
...
<form align="center" action="upload.php"
           method="post"
