...
<nav role="navigation" class="menu">
    ...
    <div class="overflow-container">
        ...
        <ul class="menu-dropdown">
            ...
            <li><a href="#">Upload Certificates</a><span class="icon"><i class="fa fa-dashboard"></i></span></li>

            <li class="menu-hasdropdown">
                <a href="#">KTU Guidelines</a><span class="icon"><i class="fa fa-gear"></i></span>
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="face face2">
                <div class="content">
                    <p>Participate in College/State/National/International events throughout the academy year which will help you gain new experience.</p>
